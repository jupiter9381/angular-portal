...
export class AuthService {
  ...
  login(email: string, password: string): Observable<User> {
    return this.http.post<User>(API_USERS_URL + '/login', {email: email, password: password});
  }
  ...
  getUserByToken(): Observable<User> {
    ...
    return this.http.post<User>(API_USERS_URL + '/getUserByToken', {token: userToken}, {headers: httpHeaders});
  }
  ...
  updateUser(_user: User): Observable<any> {
    const httpHeaders = new HttpHeaders();
    httpHeaders.set('Content-Type', 'application/json');
    return this.http.post( API_USERS_URL + '/update', _user, {headers: httpHeaders});
  }
  ...
  createRole(role: Role): Observable<Role> {
    ...
    const httpHeaders = new HttpHeaders();
    httpHeaders.set('Content-Type', 'application/json');
    return this.http.post<Role>( API_ROLES_URL + '/create', role, {headers: httpHeaders});
  }
  ...
  updateRole(role: Role): Observable<any> {
    const httpHeaders = new HttpHeaders();
    httpHeaders.set('Content-Type', 'application/json');
    return this.http.post( API_ROLES_URL + '/update', role, {headers: httpHeaders});
  }
